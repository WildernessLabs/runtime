...
#if !defined(CLOCK_MONOTONIC) || defined(HOST_DARWIN) || defined(HOST_WASI) || defined(HOST_NUTTX)
...
#if !defined(__HAIKU__) && !defined(MUSL) && !defined(__NuttX__) && defined (PTHREAD_PRIO_INHERIT) && HAVE_DECL_PTHREAD_MUTEXATTR_SETPROTOCOL
