...
#if !defined(TARGET_OSX) && !(defined (__arm__) && defined (HAVE_ARMV7) && (defined(TARGET_IOS) || defined(TARGET_TVOS) || defined(TARGET_WATCHOS) || defined(TARGET_ANDROID) || defined(TARGET_NUTTX)))
#define MONO_ATOMIC_USES_LOCK
#endif
#endif
