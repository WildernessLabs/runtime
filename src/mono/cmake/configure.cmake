...
if(HOST_NUTTX)
  set(CMAKE_REQUIRED_DEFINITIONS "${CMAKE_REQUIRED_DEFINITIONS} -D__NuttX__ -D_REENTRANT")
endif()
...
elseif(HOST_WASI)
  ...
  set(HAVE_MMAP 1)
elseif(HOST_NUTTX)
  # NuttX is a POSIX-like RTOS but many checks give false positives due to
  # newlib stubs — override with what NuttX actually provides.
  set(HAVE_STRTOK_R 1)
  ...
  # NuttX does have these POSIX basics
  set(HAVE_GETPID 1)
  set(HAVE_UNISTD_H 1)
  set(HAVE_FCNTL_H 1)
  set(HAVE_SYS_STAT_H 1)
