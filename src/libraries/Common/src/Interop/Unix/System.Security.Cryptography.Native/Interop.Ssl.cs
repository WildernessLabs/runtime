...
internal static partial class Interop
{
    internal static partial class Ssl
    {
        ...
        [LibraryImport(Libraries.CryptoNative, EntryPoint = "CryptoNative_SslGetPeerCertVerifyResult")]
        internal static partial int SslGetPeerCertVerifyResult(SafeSslHandle ssl);
