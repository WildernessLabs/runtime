...
if(CLR_CMAKE_HOST_OS STREQUAL generic AND CMAKE_SYSTEM_VARIANT STREQUAL "nuttx")
    set(CLR_CMAKE_HOST_UNIX 1)
...
if (NOT (CLR_CMAKE_TARGET_OS STREQUAL CLR_CMAKE_HOST_OS) AND NOT CLR_CMAKE_TARGET_WASI AND NOT CLR_CMAKE_TARGET_ANDROID AND NOT CLR_CMAKE_TARGET_BROWSER AND NOT CLR_CMAKE_TARGET_NUTTX)
...
if(NOT CLR_CMAKE_TARGET_BROWSER AND NOT CLR_CMAKE_TARGET_WASI AND NOT CLR_CMAKE_TARGET_NUTTX)
